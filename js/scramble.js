...
/**
 * NOT IN USE. Kept for reference; the site runs `text-roll.ts` instead.
 *
...
function splitIntoCharacters(roots) {
    const chars = [];
...
const asteriskWidths = new WeakMap();
function asteriskWidth(sample) {
